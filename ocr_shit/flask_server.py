...
def merge_boxes(detections, distance_threshold=20):
    """
    ...
    for bbox, text, score in detections:
        ...
        for merged in merged_boxes:
            ...
            if (abs(merged_x_min - x_min) < distance_threshold and
                abs(merged_y_min - y_min) < distance_threshold):
...
def process_image():
    ...
    for bbox, text, score in merged_detections:
        if score > 0.25:  # Apply threshold filter
            box = {
